...
type Props<T> = {
     ...
     * Pass a function when rows can be protected for different reasons — it is
     * the only explanation the user gets for a control that does nothing.
     */
    protectedLabel?: string | ((row: T) => string);
